...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
trenz.biz:user:AXI_StreamCapture:1.0\
trenz.biz:user:axis_concat:1.0\
xilinx.com:ip:xlslice:1.0\
xilinx.com:ip:xlconcat:2.1\
xilinx.com:ip:axis_subset_converter:1.1\
xilinx.com:ip:axi_datamover:5.1\
trenz.biz:user:axi_reg32:1.0\
trenz.biz:user:axis_AD7403:1.1\
xilinx.com:ip:axis_broadcaster:1.1\
xilinx.com:ip:axis_data_fifo:1.1\
trenz.biz:user:axis_decimate:1.0\
trenz.biz:user:axis_encoder:1.0\
trenz.biz:user:axis_monitor:1.0\
trenz.biz:user:axis_pwm:1.0\
trenz.biz:user:clk_mux:1.0\
xilinx.com:ip:clk_wiz:6.0\
xilinx.com:ip:proc_sys_reset:5.0\
xilinx.com:ip:zynq_ultra_ps_e:3.2\
trenz.biz:user:rpm_check:1.0\
xilinx.com:ip:vio:3.0\
xilinx.com:ip:xlconstant:1.1\
trenz.biz:hls:Clarke_Direct:1.0\
trenz.biz:hls:Clarke_Inverse:1.0\
trenz.biz:hls:Filters:1.0\
trenz.biz:hls:PI_Control:1.0\
trenz.biz:hls:Park_Direct:1.0\
trenz.biz:hls:Park_Inverse:1.0\
trenz.biz:hls:SVPWM:1.0\
trenz.biz:user:foc_control:1.0\
"
...
proc create_root_design { parentCell } {
  ...
  set axis_AD7403_0 [ create_bd_cell -type ip -vlnv trenz.biz:user:axis_AD7403:1.1 axis_AD7403_0 ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {149.658} \
   CONFIG.CLKOUT1_PHASE_ERROR {403.700} \
  ...
  # Create instance: psu, and set properties
  set psu [ create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e:3.2 psu ]
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__ACT_FREQMHZ {50.000} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets FOC_m_axis_V] [get_bd_intf_pins axis_monitor_0/s06_axis] [get_bd_intf_pins tx_fifo/S_AXIS]
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins ps7_0_axi_periph/S00_AXI] [get_bd_intf_pins psu/M_AXI_HPM0_FPD]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins psu/S_AXI_HP0_FPD]
...
connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axis_broadcaster_0/M01_AXIS] [get_bd_intf_pins axis_monitor_0/s00_axis]
  ...
  connect_bd_net -net BTN0_1 [get_bd_pins rpm_check_0/button] [get_bd_pins vio_0/probe_out0] [get_bd_pins xlconcat_1/In2]
  connect_bd_net -net BTN1_1 [get_bd_pins vio_0/probe_out1] [get_bd_pins xlconcat_1/In3]
  connect_bd_net -net BTN2_1 [get_bd_pins vio_0/probe_out2] [get_bd_pins xlconcat_1/In4]
  connect_bd_net -net BTN3_1 [get_bd_pins vio_0/probe_out3] [get_bd_pins xlconcat_1/In5]
  ...
  connect_bd_net -net SW0_1 [get_bd_pins clk_mux_0/sel] [get_bd_pins rpm_check_0/ss_in] [get_bd_pins vio_0/probe_out4]
  ...
  connect_bd_net -net emio_uart0_ctsn_0_1 [get_bd_ports BT_ctsn] [get_bd_pins psu/emio_uart0_ctsn]
  ...
  connect_bd_net -net xlconcat_1_dout1 [get_bd_pins axi_reg32_0/RR4] [get_bd_pins vio_0/probe_in0] [get_bd_pins xlconcat_1/dout]
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces axi_datamover_0/Data_S2MM] [get_bd_addr_segs psu/SAXIGP2/HP0_DDR_LOW] SEG_psu_HP0_DDR_LOW
  create_bd_addr_seg -range 0x00010000 -offset 0xA3C00000 [get_bd_addr_spaces psu/Data] [get_bd_addr_segs AXI_StreamCapture_0/S_AXI/S_AXI_reg] SEG_AXI_StreamCapture_0_S_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA3C10000 [get_bd_addr_spaces psu/Data] [get_bd_addr_segs axi_reg32_0/S_AXI/S_AXI_reg] SEG_axi_reg32_0_S_AXI_reg
